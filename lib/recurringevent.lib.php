...
function getFormConfirmRecurringEvent($form, $object, $action)
{
    ...
    if ($action === 'valid' && !empty($user->hasRight('recurringevent', 'write')))
    {
    ...
    elseif ($action === 'accept' && !empty($user->hasRight('recurringevent', 'write')))
    {
    ...
    elseif ($action === 'refuse' && !empty($user->hasRight('recurringevent', 'write')))
    {
    ...
    elseif ($action === 'reopen' && !empty($user->hasRight('recurringevent', 'write')))
    {
    ...
    elseif ($action === 'delete' && !empty($user->hasRight('recurringevent', 'write')))
    {
    ...
    elseif ($action === 'clone' && !empty($user->hasRight('recurringevent', 'write')))
    {
    ...
    elseif ($action === 'cancel' && !empty($user->hasRight('recurringevent', 'write')))
    {
